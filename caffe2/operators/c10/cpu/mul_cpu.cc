...
void mul_op_cpu_impl(const Tensor<CPUContext>& A, const Tensor<CPUContext>& B, Tensor<CPUContext> *C, bool legacy_broadcast, int axis, CPUContext* context) {
