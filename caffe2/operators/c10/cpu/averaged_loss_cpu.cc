...
template<class T>
void averaged_loss_op_cpu_impl(const Tensor<CPUContext>& X, Tensor<CPUContext> *sum, caffe2::ops::AveragedLoss::State* state, CPUContext* context) {
...
namespace c10 {
    C10_REGISTER_KERNEL(caffe2::ops::AveragedLoss)
        .kernel(&averaged_loss_op_cpu_impl<float>)
