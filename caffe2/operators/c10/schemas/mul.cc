#include "caffe2/operators/c10/schemas/mul.h"
...
struct LegacyBroadcastParameter final {
    using type = bool;
    static constexpr const char* name() { return "legacy_broadcast"; }
...
namespace caffe2 {
    REGISTER_C10_OPERATOR_FOR_CAFFE2_DISPATCH_WITH_PARAMETERS(ops::Mul, void, C10Mul_DontUseThisOpYet, ParameterHelper<LegacyBroadcastParameter>, ParameterHelper<AxisParameter>)
}
